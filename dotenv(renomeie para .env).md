...
MONGODB_URI=mongodb+srv://isabella:isabella@cluster0.vttrsef.mongodb.net/?appName=Cluster0


# Chave secreta para assinar os tokens JWT
# Use uma string longa e aleatória (ex: gerada em https://randomkeygen.com/)
JWT_SECRET=wrap-later-fade
...
EMAIL_PORT=587
EMAIL_USER=isabella.mcastro02@gmail.com
EMAIL_PASS=lcuurpftppqnpfel
